window.addEventListener('DOMContentLoaded', () => {
    ...
    $('.review__slider').slick({
      ...
      slidesToShow: 3,
      slidesToScroll: 1,
      prevArrow: "<div id='prev' class='next-arrow'><img class='img-svg' src='https://www.pracasofar.com.ua/wp-content/themes/vacancies/src/img/icon/arrow.svg'></div>",
      nextArrow: "<div id='next' class='prev-arrow'><img class='img-svg' src='https://www.pracasofar.com.ua/wp-content/themes/vacancies/src/img/icon/arrow.svg'></div>",
      responsive: [
        {
          breakpoint: 768,
          settings: {
