...
$products_list = array(
    0 => array(
        'product_id' => $_REQUEST['id1'],    //код товара (из каталога CRM)
        'price'      => $_REQUEST['price1'], //цена товара 1
        'count'      => $_REQUEST['count1'],                     //количество товара 1
    ),
    1  => array(
        'product_id' => $_REQUEST['id2'],    //код товара (из каталога CRM)
        'price'      => $_REQUEST['price2'], //цена товара 1
        'count'      => $_REQUEST['count2'],                     //количество товара 1
    ),
    2  => array(
        'product_id' => $_REQUEST['id3'],    //код товара (из каталога CRM)
        'price'      => $_REQUEST['price3'], //цена товара 1
        'count'      => $_REQUEST['count3'],                     //количество товара 1
    ),
    3  => array(
        'product_id' => $_REQUEST['id4'],    //код товара (из каталога CRM)
        'price'      => $_REQUEST['price4'], //цена товара 1
        'count'      => $_REQUEST['count4'],                     //количество товара 1
    ),
    4  => array(
        'product_id' => $_REQUEST['id5'],    //код товара (из каталога CRM)
        'price'      => $_REQUEST['price5'], //цена товара 1
        'count'      => $_REQUEST['count5'],                     //количество товара 1
    ),
    5  => array(
        'product_id' => $_REQUEST['id6'],    //код товара (из каталога CRM)
        'price'      => $_REQUEST['price6'], //цена товара 1
        'count'      => $_REQUEST['count6'],                     //количество товара 1
    )
);
...
// параметры запроса
$data = array(
    'key'             => '32247943ee7c558196d0f29eae68d4b4', //Ваш секретный токен
...
// запрос
$curl = curl_init();
curl_setopt($curl, CURLOPT_URL, 'http://testik.lp-crm.biz/api/addNewOrder.html');
